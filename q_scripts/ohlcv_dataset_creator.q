...
loadcsv: {[csvpath;marketopen;marketclose]
    ...
    ohlcv: select open: first price, high: max price, low: min price, close: last price, volume: sum size by date from trades;

    // Show the OHLCV dataset
    show ohlcv

 }

loadcsv["/home/fabio/data/IBM_trades.csv";13:30:00.000000000; 20:00:00.000000000]
